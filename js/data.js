export const cieBioNotes = [
  ...
  },
  {
    "description": "",
    "id": "0610_08_01",
    "label": "Xylem and phloem",
    "type": "title",
    "status": "show",
    "order": 1
  },
  {
    "description": "Vascular bundles are made up of groups of specialised cells that carry water, dissolved salts and food up or down the stem. The vascular bundles in the roots, stem, leaf stalks and leaf veins all join to form a transport system through the whole plant. The two main tissues in the vascular bundles are called xylem and phloem. The position of xylem and phloem in the root and shoot helps the stem to withstand sideways bending and the root to resist pulling forces.",
    "label": "",
    "id": "0610_08_01",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "sucrose and amino acids are transported in the phloem\nwater and mineral ions are transported in the xylem",
    "id": "0610_08_01",
    "label": "",
    "type": "list",
    "order": 3,
  ...
  {
    "description": "made up of a series of long cells joined end to end\nhollow and has no cell contents\nlined by lignin, which makes the cell walls very strong and impermeable",
    "label": "Structure of xylem vessel",
    "id": "0610_08_01",
    "type": "list",
    "status": "show",
    "order": 4
  ...
  {
    "description": "The root hairs make very close contact with soil particles and are the main route by which water and mineral salts enter the plant. The root hair cells have tiny projections, which provide a large surface area to take up water from the soil by osmosis and to absorb mineral ions by active transport.",
  ...
  {
    "description": "The water enters the root hair cells and is then passed on to cells in the root cortex. It enters the xylem vessels and moves up the stem and into the leaves.",
    "label": "Transport of water and ions",
    "id": "0610_08_02",
    "type": "text",
    "status": "show",
    "order": 3
  ...
  {
    "description": "Transpiration is the loss of water vapour from leaves. Water evaporates from mesophyll cells and water vapour diffuses out through stomata.",
    "label": "",
    "id": "0610_08_03",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "Evaporation at the leaf creates a low water potential in mesophyll cells, drawing water out of the leaf xylem.\nThis creates a tension that is transmitted all the way down the xylem vessels.\nWater molecules stay intact as a continuous column due to cohesion (water molecules sticking to each other) and adhesion (water molecules sticking to the cellulose walls of the xylem).\nThis tension pulls water up from the roots, driving water uptake from the soil into root hairs via osmosis.",
  ...
  {
    "description": "Wilting happens when the rate of transpiration exceeds the rate of water absorption by the root hairs.",
    "id": "0610_08_03",
    "label": "Wilting",
    "type": "text",
    "order": 5,
  ...
  {
    "description": "Cells lose water and change from a turgid state to a flaccid state.\nThe turgor pressure inside the plant cells drops, meaning the cell contents no longer push firmly against the cell walls.\nWithout turgor pressure for structural support, the stems, leaves, and soft tissues of the plant collapse and droop.",
    "label": "",
    "id": "0610_08_03",
    "type": "list",
    "order": 6,
  ...
  {
    "description": "Translocation is the movement of sucrose and amino acids in the phloem from source to sinks.",
    "id": "0610_08_04",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Sources are the parts of plants that release sucrose or amino acids.",
    "label": "Source",
    "id": "0610_08_04",
    "type": "text",
    "order": 3,
  ...
  {
    "description": "Mature green leaves\nStorage organs (tuber/bulb) during early spring",
    "id": "0610_08_04",
    "label": "",
    "type": "list",
    "order": 4,
  ...
  {
    "description": "Sinks are the parts of plants that use or store sucrose or amino acids.",
    "id": "0610_08_04",
    "label": "Sink",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Growing roots and stem tips (meristems)\nDeveloping flowers, fruits, and seeds\nStorage organs (tubers/roots) during late summer",
    "id": "0610_08_04",
    "label": "",
    "type": "list",
    "order": 6,
  ...
  {
    "description": "",
    "label": "Comparison of transpiration stream and translocation",
    "id": "0610_08_05",
    "type": "title",
    "order": 1,
    "status": "show"
  ...
  {
    "description": "Feature|Transpiration Stream|Translocation\nTransport tissue|xylem|phloem\nSubstances transported|water and dissolved mineral ions|sucrose and amino acids\nDirection of Flow|one way only: upwards from roots to leaves|two ways: up or down from sources to sinks\nMechanism|passive physical forces (evaporation pull, cohesion, adhesion, tension)|active transport (energy required to load sucrose into phloem)",
    "id": "0610_08_05",
    "label": "",
    "type": "table",
    "status": "show",
  ...
  {
    "description": "",
    "label": "Nervous control in human",
    "id": "0610_14_01",
    "type": "title",
    "status": "show",
    "order": 1
  ...
  {
    "description": "The nerves that connect the body to the central nervous system make up the peripheral nervous system.",
  ...
  {
    "description": "Name|Function\nMotor neurones|carry impulses from the CNS to muscle and glands\nSensory neurones|carry impulses from the sense organs to the CNS\nRelay neurones|make connections to other neurones inside the CNS",
    "label": "Types of nerve cells (neurones)",
    "id": "0610_14_01",
    "type": "list",
    "order": 4,
    "status": "show"
  ...
  {
    "description": "Synapses control the direction of impulses because neurotransmitter molecules are only synthesised on one side of the synapse and receptor proteins are only present on the other side. They slow down the speed of nerve impulses slightly because of the time taken for the chemical to diffuse across the synaptic gap.",
    "id": "0610_14_03",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "A reflex action is a means of automatically and rapidly integrating and coordinating stimuli with the responses of effectors (muscles and glands).",
    "id": "0610_14_04",
    "label": "",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "stimulus → receptor → sensory neurone → coordination (spinal cord) → motor neurone → effector → response",
    "label": "",
    "id": "0610_14_04",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Sense organs are groups of receptor cells responding to specific stimuli such as light, sound, touch, temperature and chemicals.",
    "id": "0610_14_05",
    "label": "Sense organs",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "A hormone is defined as a chemical substance, produced by a gland and carried by the blood, which alters the activity of one or more specific target organs.",
    "label": "",
    "id": "0610_14_08",
    "type": "text",
    "status": "show",
  ...
  },
  {
    ...
    "id": "0610_14_08",
    "label": "Comparison of nervous and endocrine control",
    "type": "table",
    "order": 3,
    "status": "show"
  },
  ...
  {
    "description": "Pancreas release glucagon into the bloodstream.\nGlucagon triggers liver cells to convert stored glycogen into glucose.\nGlucose enters the bloodstream, restoring levels.",
    "id": "0610_14_10",
    "label": "Response to low blood glucose level",
    "type": "list",
    "status": "show",
    "order": 3
  },
  {
    "description": "Pancreatic islet cells release insulin.\nInsulin stimulates liver cells to convert glucose into glycogen for storage.\nIt increases glucose uptake in all body cells for respiration.\nIt promotes the conversion of carbohydrates to fats and inhibits the conversion of protein to carbohydrates.",
    "label": "Response to high blood glucose level",
    "id": "0610_14_10",
    "type": "list",
    "status": "show",
    "order": 4
  ...
  {
    "description": "Symptoms include high concentration of glucose in the blood and it is excreted in the urine, thirst, weight loss and coma and death in serious cases.\nManagements include daily injection of insulin to maintain the glucose within normal range, check blood glucose using a glucometer, limit the amount of carbohydrate in the diet.",
    "label": "",
    "id": "0610_14_10",
    "type": "list",
    "order": 6,
  ...
  {
    "description": "Stimulus|Name|Response of shoots|Response of roots\nlight|phototropism|positive phototropism (grow towards light source)|negative phototropism (grow away from light in some species)\ngravity|gravitropism|negative gravitropism (grow away from direction of gravity)|positive gravitropism (grow towards direction of gravity)",
    "id": "0610_14_12",
    "label": "Main tropic responses",
    "type": "table",
    "order": 4,
    "status": "show"
  },
  {
    "description": "Response|Advantage\nPositive phototropism of shoots|brings leaves into the best situation for photosynthesis, and flowers are most likely to be seen and pollinated by flying insects\nNegative gravitropism of shoots|lifts leaves and flowers above the ground and helps the plant to compete for light and carbon dioxide, and seed dispersal may be more effective\nPositive gravitropism in roots|move deeper to get water and mineral ions, and for anchorage",
    "id": "0610_14_12",
    "label": "Advantages of tropic responses",
    "type": "table",
    "order": 5,
    "status": "show"
  },
  ...
  {
    "description": "Asexual reproduction is the process resulting in the production of genetically identical offspring from one parent.",
    "label": "",
    "id": "0610_16_01",
    "type": "text",
    "status": "show",
  ...
  },
  {
    ...
    "label": "Methhods of asexual reproduction in plants",
    "id": "0610_16_01",
    "type": "table",
    "status": "show",
    "order": 3
  ...
  {
    "description": "No mate is needed.\nNo gametes are needed.\nAll the good characteristics of the parent are passed on to the offspring, resulting in uniform crops and stable varieties.\nWhere there is no dispersal and offspring will grow in the same favourable environment as the parent.\nPlants that reproduce asexually usually store large amounts of food that allow rapid growth when conditions are suitable.",
    "id": "0610_16_01",
    "label": "Advantages of asexual reproduction",
    "type": "list",
    "status": "show",
    "order": 4
  },
  {
    "description": "There is little variation created, so adaptation to a changing environment is unlikely.\nIf the parent has no resistance to a particular disease, none of the offspring will have resistance. This could affect all of a crop.\nLack of dispersal can lead to competition for nutrients, water and light.",
    "label": "Disadvantages of asexual reproduction",
    "id": "0610_16_01",
    "type": "list",
    "order": 5,
    "status": "show"
  ...
  {
    "description": "Sexual reproduction is a process involving the fusion of the nuclei of two gametes to form a zygote and the production of offspring that are genetically different from each other.",
    "id": "0610_16_02",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "There is variation in the offspring, so adaptation to a changing or new environment is likely, enabling survival of the species.\r\nNew varieties can be created, which may have resistance\r\nto disease.\nIn plants, seeds are produced, which allow dispersal away from the parent plant, reducing competition.",
    "label": "Advantages of sexual reproduction",
    "id": "0610_16_02",
    "type": "list",
    "order": 4,
    "status": "show"
  ...
  {
    "description": "Two parents are usually needed.\nGrowth of a new plant to maturity from a seed is slow.",
    "id": "0610_16_02",
    "label": "Disadvantages of sexual reproduction",
    "type": "list",
    "status": "show",
    "order": 5
  },
  ...
  {
    "description": "Pollination is the transfer of pollen grains from an anther to a stigma.",
    "label": "Pollination",
    "id": "0610_16_03",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "much smaller and are produced in much larger numbers\nacrosome secretes enzymes to digest the jelly coat of an egg cell\nmid-piece contains many mitochondria to provide energy\nmovement is propelled by the flagellum",
    "id": "0610_16_06",
    "label": "Sperm cell",
    "type": "list",
    "order": 2,
  ...
  {
    "description": "much larger and only one egg is released each month\njelly coat protects the contents of the cell and prevents more than one sperm from entering and fertilising the egg\ncytoplasm is rich in fats and proteins to provide energy and growth if the egg is fertilised",
    "id": "0610_16_06",
    "label": "Egg cell",
    "type": "list",
    "order": 3,
  ...
  {
    "description": "Fertilisation is the fusion of the nuclei from a male gamete (sperm) and a female gamete (egg cell).",
    "label": "Fertilisation",
    "id": "0610_16_06",
    "type": "text",
    "order": 4,
  ...
  {
    "description": "the sperms swim through the cervix into the uterus\nenter the oviduct\nwhen a sperm bump an ovum, the acrosome secretes enzymes which digest the jelly coat\nthe sperm then enters the cytoplasm of the ovum\nthe male nucleus of sperm fuses with the female nucleus",
    "id": "0610_16_06",
    "label": "",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "A sexually transmitted infection (STI) is an infection that is transmitted through sexual contact.",
    "id": "0610_16_09",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "AIDS stands for acquired immune deficiency syndrome, caused by the human immunodeficiency virus. There is often a long latent period (years) between infection and symptom development. Carriers may show no symptoms but can still transmit the virus.",
    "label": "AIDS and HIV",
    "id": "0610_16_09",
    "type": "text",
    "order": 3,
  ...
  {
    "description": "blood-to-blood contact: sharing contaminated needles (e.g., drug use) or infected blood products\nsexual transmission: via sexual intercourse (without using condoms)\nvertical transmission (mother-to-child): occurs in the uterus, during birth, or via breast milk",
    "id": "0610_16_09",
    "label": "",
    "type": "list",
    "order": 4,
  ...
  {
    "description": "antibiotics are effective against bacterial STIs (e.g., syphilis, gonorrhoea) but ineffective against HIV (a virus)\nantiretrovirals slow down the progression of HIV/AIDS",
    "label": "Treatment of STIs",
    "id": "0610_16_09",
    "type": "list",
    "order": 5,
    "status": "show"
  ...
  {
    "description": "behavioral: faithful, long-term relationships with one partner; avoiding sexual contact with individuals who may be infected\nbarrier methods: Use of condoms or Femidoms to block the transfer of pathogens\npublic health: early treatment is essential; all sexual partners must be treated simultaneously to prevent re-infection",
    "label": "Prevention of STIs",
    "id": "0610_16_09",
    "type": "list",
    "status": "show",
    "order": 6
  ...
  {
    "description": "A recessive allele is expressed only when two copies are present.",
    "id": "0610_17_08",
  ...
  {
    "description": "The affected male inherits the recessive allele from mother. The affected male passes the recessive allele to his daughters.",
    "label": "",
    "id": "0610_17_08",
    "type": "text",
    "order": 17,
  ...
  {
    "description": "New alleles arise through mutations in genes. A change in the DNA base sequence creates a new version (allele) of that gene. If mutation occurs in a gamete, it can be inherited by offspring. The new alleles increase genetic diversity.",
    "id": "0610_18_02",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Process|Method\nMutation|creates new alleles\nMeiosis|shuffles existing alleles during gamete formation\nRandom fertilisation|any random sperm can fuse with any egg\nRandom mating|mixes genotypes across the gene pool",
    "id": "0610_18_02",
  ...
  {
    "description": "Adaptation|Feature\nLong roots|reach deep water in the sand\nLeaf rolling|reduces surface area for transpiration\nSunken stomata|increases humidity\nFine hairs around the stomata|reduces air movement",
    "label": "Marram grass (Ammophilia)",
    "id": "0610_18_03",
    "type": "table",
    "status": "show",
    "order": 6
  ...
  },
  {
    "description": "",
    "id": "0610_18_05",
    "label": "Artificial section (selective breeding)",
    "type": "title",
    "order": 1,
    "status": "show"
  },
  {
    "description": "Selective breeding is the process where humans choose rganisms with desirable characteristics and breed them together to produce offspring with those desired traits.",
    "label": "",
    "id": "0610_18_05",
    "type": "",
    "status": "show",
  ...
  {
    "description": "Select two organisms with desirable characteristics and cross-breeds them. The offspring produced show some of the desired characteristics. Individuals with the best characteristics are selected and cross-bred. This process is repeated over many generations to produce organisms with enhanced desirable traits.",
    "id": "0610_18_05",
  ...
  {
    "description": "collect sperm samples from the male animal (which can be used immediately or be frozen and stored)\nintroduce sperm samples artificially into a female reproductive system to fertilise eggs",
  ...
  {
    "description": "The fertilisation is allowed to take place in laboratory glasswares.",
    "id": "0610_20_07",
    "label": "In vitro fertilisation (IVF)",
    "type": "text",
    "status": "show",
    "order": 7
  },
  {
    "description": "The female is given fertility drugs, which cause the ovaries to release several mature ova at the same time.\nThe ova are collected by laproscopy.\nThe ova are mixed with seminal fluid and watched under the microscope to see cell division.\nOne or more of the dividing zygotes are introduced into the female's uterus by a tube inserted through the cervix.",
    "label": "",
    "id": "0610_20_07",
    "type": "list",
    "status": "show",
  ...
  },
  {
    ...
    "id": "0610_20_07",
    "label": "Risks to a species of decreasing population size",
    "type": "list",
    "status": "show",
    "order": 9
  },
...
export const edexcelBioNotes = [
  ...
  {
    "description": "eukaryotic\nmostly multicellular\norganised into a mycelium made from thread-like structures called hyphae, which contain many nuclei\ncell walls made of chitin\nsaprotrophs - fungi feed by extracellular secretion of digestive enzymes onto food material and absorption of the digested products\nstore carbohydrates as glycogen\ne.g. Mucor is a typical fungus with hyphae and yeast is a single-celled fungus.",
    "label": "",
    "id": "4BI1_02_05",
    "type": "list",
    "status": "show",
  ...
  },
  {
    ...
    "id": "4BI1_16_02",
    "label": "Differences between DNA and RNA",
    "type": "table",
    "order": 4,
    "status": "show"
  },
  ...
  {
    "description": "Overuse and misuse of antibiotics increase the development of antibiotic-resistant bacteria.",
    "id": "4BI1_19_02",
    "label": "",
    "type": "text",
    "order": 3,
  ...
  },
  {
    ...
    "label": "Products of genetically-modified bacteria",
    "id": "4BI1_22_01",
    "type": "list",
    "status": "show",
    "order": 9
...
export const edexcelHBioNotes = [
  ...
  {
    "description": "provide much higher magnification and resolution than light microscope\ncan see very small structures like endoplasmic reticulumn and ribosomes",
    "id": "4HB1_01_01",
  ...
  {
    "description": "Rub with a cotton swab inside the mouth.\r\nSmear the sample on a glass slide.\r\nStain with a dye to see under the microscope.\r\nPut the glass slide under the microscope and adjust the lens to see clearly.",
    "id": "4HB1_01_01",
    "label": "Preparing human cheek cell under light microscope",
    "type": "list",
    "status": "show",
    "order": 4
  },
  ...
  {
    "description": "DNA replication is the process of creating an identical copy of a DNA molecule. The new strands of DNA are assembled from nucleotide under the control of an enzyme called DNA polymerase. DNA replication occurs before cell division (mitosis or meiosis).",
    "id": "4HB1_01_02",
    "label": "DNA replication",
    "type": "text",
    "order": 5,
  ...
  {
    "description": "Cells that have a similar function are grouped together as tissues.",
    "label": "",
    "id": "4HB1_01_07",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Types|Structure|Function\nVoluntary|striated; many nuclei per cell; not branched|rapid contraction to move bone under voluntary control by the brain\nInvoluntary|non-striated (smooth); one nucleus per cell; not branched; cell tapered at ends|slow, rhytmic contraction in walls of gut, blood vessels, not under voluntary control by the brain\nStriated|many nuclei per cell; branched cells forming a strong mesh-like network|only present in heart which contracts rhythmically and constantly throught life, not under voluntary control",
    "label": "Types of muscle cell",
    "id": "4HB1_01_07",
    "type": "table",
    "status": "show",
    "order": 3
  ...
  {
    "description": "Name of tissue|Location\nCiliated epithelium|beat backwards and forwards to move liquids along\nSquamous epithelium|flattened cells lining the human cheek\nBone|a tissue made of cells that secrete a hard material made of calcium salts\nBlood|made of red and white blood cells in plasma\nNervous tissue|makes up the brain, spinal cord and nerves",
    "label": "Types of tissues",
    "id": "4HB1_01_07",
    "type": "table",
    "order": 4,
    "status": "show"
  ...
  {
    "description": "A collection of different tissues carrying out a particular function is called an organ.",
    "id": "4HB1_01_07",
    "label": "Organ",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Golden rice, which provide vitamin A",
    "id": "4HB1_01_09",
    "label": "Products of genetically-modified plants",
    "type": "list",
    "status": "show",
    "order": 10
  },
  ...
  {
    "description": "",
    "label": "Investigating the effects of osmosis on red blood cells",
    "id": "4HB1_02_03",
    "type": "title",
    "status": "show",
    "order": 1
  ...
  {
    "description": "Prepare three test tubes and label them:\nA: Distilled water (hypotonic solution)\nB: 0.9% saline solution (isotonic solution)\nC: Concentrated salt solution (hypertonic solution)\nAdd equal volumes (5 cm³) of each solution into separate test tubes.\nObtain a small sample of red blood cells and add an equal drop of blood to each test tube.\nA sample from each tube is examined under the microscope.",
    "id": "4HB1_02_03",
    "label": "Procedure",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "A: Solution becomes red and no cells are seen.\nB: Red blood cells remain normal in shape.\nC: Red blood cells appear crenated (spiky edges).",
    "label": "Observation",
    "id": "4HB1_02_03",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "A: In distilled water (hypotonic solution), water enters red blood cells by osmosis. Red blood cells swell and may burst because they lack a cell wall.\nB: In isotonic solution, water potential is equal inside and outside cells. There is no net movement of water and cells maintain normal shape.\nC: In hypertonic solution, water moves out of red blood cells by osmosis. Red blood cells shrink and become crenated.",
    "label": "Interpretation",
    "id": "4HB1_02_03",
    "type": "list",
    "order": 4,
  ...
  {
    "description": "As substrate concentration increases, enzyme activity (rate of reaction) also increases initially. More substrate molecules collide with enzyme active sites. More enzyme–substrate complexes are formed.",
    "id": "4HB1_03_03",
  ...
  {
    "description": "At high substrate concentration, all active sites are occupied. Enzymes become saturated. Adding more substrate does not increase rate further.",
    "label": "",
    "id": "4HB1_03_03",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Competitive inhibitors compete with substrate for the active site. They have a similar shape to the substrate and block substrate from binding the active site. The rate of enzyme activity decreases as the concentration of competitive inhibitor increases. However, the effect can be reduced by increasing substrate concentration.",
    "id": "4HB1_03_03",
    "label": "The presence of inhibitors",
    "type": "text",
    "status": "show",
    "order": 19
  },
  {
    "description": "Non-competitive inhibitors bind to a site other than the active site (allosteric site) and change the shape of the enzyme. Substrate can no longer bind the active site. Even if substrate increases, enzyme remains inhibited and the enzyme activity is permanently reduced.",
    "id": "4HB1_03_03",
    "label": "",
    "type": "text",
    "order": 20,
  ...
  },
  {
    "description": "",
    "id": "4HB1_03_06",
    "label": "Immobilised enzymes",
    "type": "title",
    "status": "show",
    "order": 1
  },
  {
    "description": "Immobilised enzymes are enzymes that are attached to an insoluble material or trapped within a support medium.",
    "id": "4HB1_03_06",
    "label": "",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "Mix 2 cm³ lactase solution and 8 cm³ sodium alginate solution.\nStir thoroughly.\nAdd mixture dropwise into calcium chloride solution.\nSodium alginate reacts to form calcium alginate beads.\nEnzyme becomes trapped (immobilised) inside beads.\nLeave beads for 5 mintues to set.\nSeparate using a sieve and wash with distilled water.",
    "id": "4HB1_03_06",
    "label": "Preparation of immobilised lactate beads",
    "type": "list",
    "status": "show",
    "order": 3
  },
  {
    "description": "Enzymes can be reused.\nProducts do not contain enzyme contamination.\nEnzymes are often more resistant to temperature and pH changes.\nEnzymes are less likely to be broken down by organic solvents.\nColumns of immobilised enzyme are used in large-scale production in industrial processes.",
    "id": "4HB1_03_06",
    "label": "Advantages of using immobilised enzymes",
    "type": "list",
    "status": "show",
    "order": 4
  },
  {
    "description": "lactase breaks down lactose into glucose and galactose\nMilk is passed through immobilised lactase to make it suitable for lactose-intolerant people.",
    "id": "4HB1_03_06",
  ...
  {
    "description": "invertase produced by yeast cells breaks down sucrose into glucose and fructose\nProduces invert invert syrup used in food industry (sweeter and prevents crystallisation).",
    "id": "4HB1_03_06",
    "label": "Breakdown of sucrose",
    "type": "list",
    "status": "show",
    "order": 6
  },
  {
    "description": "glucose oxidase breaks down glucose to gluconic acid and  hydrogen peroxide\nUsed in biosensors to detect glucose levels.",
    "id": "4HB1_03_06",
    "label": "Testing for glucose in blood or urine",
    "type": "list",
    "order": 7,
    "status": "show"
  },
  ...
  {
    "description": "Kwashiorkor is a disease caused by severe protein deficiency in the diet. It usually affects young children when they stop breastfeeding and eat mainly carbohydrate-rich food. The symptoms include swollen abdomen and ankle due to fluid retention (oedema), poor growth and development, thin fragile hair and skin changes.",
    "label": "Kwashiorkor",
    "id": "4HB1_04_05",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "",
    "label": "Investigating the vitamin C content of the lemon juice",
    "id": "4HB1_04_07",
    "type": "title",
    "order": 1,
    "status": "show"
  ...
  {
    "description": "Add 5 ml of DCPIP solution (blue) into a test tube.\nAdd the lemon juice drop by drop, shaking the test tube after each drop.\nRecord the number of drops required to decolourise the DCPIP solution.",
    "label": "Procedure",
    "id": "4HB1_04_07",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "The blue colour fades and becomes colourless.",
    "label": "Observation",
    "id": "4HB1_04_07",
    "type": "text",
    "order": 3,
  ...
  {
    "description": "Lemon juice contains vitamin C (ascorbic acid). A smaller volume of fruit juice sample used indicates a higher vitamin C content in the juice.",
    "label": "Interpretation",
    "id": "4HB1_04_07",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Tooth decay is more likely to occur in molars because they have ridges where food leftover may be stuck, and they are difficult to be brushed.\nBacteria can also form plaque, an invisible layer on the surface of the teeth. If plaque is left on the teeth, it forms tartar, which has to be removed by a dentist.\nBacteria feed on sugar and release acids which dissolve the enamel.\nWhen enamel is penetrated, acid breaks down the dentine forming a cavity.\nThe decay eventually reaches the nerves in the pulp cavity and causes pain.",
    "label": "Tooth decay",
    "id": "4HB1_04_12",
    "type": "list",
    "order": 5,
  ...
  {
    "description": "BMI is a measure used to assess whether a person has a healthy body weight in relation to their height.",
    "id": "4HB1_04_18",
    "label": "",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "BMI = mass (kg)/height (m^2)",
    "id": "4HB1_04_18",
    "label": "Formula",
    "type": "text",
    "order": 3,
  ...
  {
    "description": "An obese person has a higher risk of coronary heart disease and stroke.",
    "label": "",
    "id": "4HB1_04_18",
    "type": "text",
    "status": "show",
  ...
  {
    "description": "Food hygiene is to the practices used to prevent contamination of food and reduce the risk of food-borne diseases.",
    "label": "",
    "id": "4HB1_04_19",
    "type": "text",
    "order": 2,
  ...
  {
    "description": "Prevents growth and spread of pathogenic microorganisms\nReduces risk of food poisoning (e.g. Salmonella enterica, Listeria monocytogenes)\nKeeps food safe for consumption",
    "id": "4HB1_04_19",
    "label": "",
    "type": "list",
    "status": "show",
  ...
  {
    "description": "Cooked and raw food should not be stored together.\nFood that have been frozen and thawed should be cooked and eaten straight right away, and not re-frozen.\nFood should not be left in the open air or on a work surface.",
    "id": "4HB1_04_19",
    "label": "Preventing transmission of microorganisms in food",
    "type": "list",
    "status": "show",
    "order": 4
  },
  {
    ...
    "id": "4HB1_04_19",
    "label": "Food preservation methods",
    "type": "list",
    "order": 5,
    "status": "show"
  },
  ...
  },
  {
    "description": "",
    "id": "4HB1_05_09",
    "label": "Measuring lung volumes",
    "type": "title",
    "status": "show",
    "order": 1
  },
  {
    "description": "Close the nose with a nose clip and set the rotating drum (kymograph) to rotate slowly.\nTo record tidal volume, breathe in and out through the mouthpiece in a relaxed state. The lid moves up and down, and a pen records breathing movements on the kymograph.\nTo record vital capacity, take a deep breath, then breathe out through the mouthpiece in one long, continuous breath.\nBreathing rate is calculated by counting the number of peaks or troughs in a fixed time and dividing by the time.\nDuring spirometry, the tracing gradually drops over time.\nVolume of oxygen used is calculated as the difference in volume at a peak (or trough) from the start to the end of the spirogram.",
    "label": "Using spirometry",
    "id": "4HB1_05_09",
    "type": "list",
    "status": "show",
    "order": 2
  ...
  {
    "description": "During exercise, muscles carry out more aerobic respiration, producing more carbon dioxide in the blood.\nReceptors in the medulla and arteries detects the increase in carbon dioxide.\nReceptors send signals to the respiratory centre in the brain.\nRespiratiory centre stimulates the diaphragm and intercostal muscles to contract and relax more rapidly.\nFaster and deeper breathing supplies extra oxygen to the muscles and removes excess carbon dioxide.\nCarbon dioxide in the blood decreases to the normal level.",
    "id": "4HB1_05_10",
    "label": "",
    "type": "list",
    "order": 3,
...
export const edexcelBioChapters = [
  {
    "unit": 1,
    "label": "Organisms and Life Processes",
    "chapters": [
      { "chapterId": "4BI1_01", "num": 1, "label": "Life Processes", color: "#0000C0" },
      { "chapterId": "4BI1_02", "num": 2, "label": "The Variety of Living Organisms", color: "#0000C0" }
    ]
  },
  {
    "unit": 2,
    ...
    "chapters": [
      { "chapterId": "4BI1_03", "num": 3, "label": "Breathing and Gas Exchange", color: "#C00000" },
      { "chapterId": "4BI1_04", "num": 4, "label": "Food and Digestion", color: "#C00000" },
      { "chapterId": "4BI1_05", "num": 5, "label": "Blood and Circulation", color: "#C00000" },
      { "chapterId": "4BI1_06", "num": 6, "label": "Coordination", color: "#C00000" },
      { "chapterId": "4BI1_07", "num": 7, "label": "Chemical Coordination", color: "#C00000" },
      { "chapterId": "4BI1_08", "num": 8, "label": "Homeostasis and Excretion", color: "#C00000" },
      { "chapterId": "4BI1_09", "num": 9, "label": "Reproduction in Humans", color: "#C00000" }
    ]
  },
  {
    "unit": 3,
    ...
    "chapters": [
      { "chapterId": "4BI1_10", "num": 10, "label": "Plants and Food", color: "#00C000" },
      { "chapterId": "4BI1_11", "num": 11, "label": "Transport in Plants", color: "#00C000" },
      { "chapterId": "4BI1_12", "num": 12, "label": "Chemical Coordination in Plants", color: "#00C000" },
      { "chapterId": "4BI1_13", "num": 13, "label": "Reproduction in Plants", color: "#00C000" }
    ]
  },
  {
    "unit": 4,
    "label": "Ecology and the Environment",
    "chapters": [
      { "chapterId": "4BI1_14", "num": 14, "label": "Ecosystems", color: "#800080" },
      { "chapterId": "4BI1_15", "num": 15, "label": "Human Influences on the Environment", color: "#800080" }
    ]
  },
  {
    "unit": 5,
    "label": "Variation and Selection",
    "chapters": [
      { "chapterId": "4BI1_16", "num": 16, "label": "Chromosomes, Genes and DNA", color: "#0000C0" },
      { "chapterId": "4BI1_17", "num": 17, "label": "Cell Division", color: "#0000C0" },
      { "chapterId": "4BI1_18", "num": 18, "label": "Genes and Inheritance", color: "#0000C0" },
      { "chapterId": "4BI1_19", "num": 19, "label": "Natural Selection and Evolution", color: "#800080" },
      { "chapterId": "4BI1_20", "num": 20, "label": "Selective Breeding", color: "#800080" }
    ]
  },
  {
    "unit": 6,
    "label": "Microorganisms and Genetic Modification",
    "chapters": [
      { "chapterId": "4BI1_21", "num": 21, "label": "Using Microorganisms", color: "#800080" },
      { "chapterId": "4BI1_22", "num": 22, "label": "Genetic Modification", color: "#800080" }
    ]
  }
]

export const edexcelHBioChapters = [
  {
    chapters: [
      { chapterId: "4HB1_01", num: 1, label: "Cells", color: "#0000C0" },
      { chapterId: "4HB1_02", num: 2, label: "Movement of substances into and out of cells", color: "#0000C0" },
      { chapterId: "4HB1_03", num: 3, label: "Biological molecules", color: "#0000C0" },
      { chapterId: "4HB1_04", num: 4, label: "Nutrition and energy", color: "#C00000" },
      { chapterId: "4HB1_05", num: 5, label: "Respiration and gas exchange", color: "#C00000" },
      { chapterId: "4HB1_06", num: 6, label: "Internal transport", color: "#C00000" },
      { chapterId: "4HB1_07", num: 7, label: "Bones, muscles and joints", color: "#C00000" },
      { chapterId: "4HB1_08", num: 8, label: "Sensory receptors - the eye and the ear", color: "#C00000" },
      { chapterId: "4HB1_09", num: 9, label: "Coordination", color: "#C00000" },
      { chapterId: "4HB1_10", num: 10, label: "Homeostasis and excretion", color: "#C00000" },
      { chapterId: "4HB1_11", num: 11, label: "Reproduction", color: "#C00000" },
      { chapterId: "4HB1_12", num: 12, label: "Heredity", color: "#0000C0" },
      { chapterId: "4HB1_13", num: 13, label: "Microorganisms", color: "#800080" },
    ]
  }
]

export const cieBioChapters = [
  {
    chapters: [
      { chapterId: "0610_01", num: 1, paper2: "yes", color: "#0000C0", label: "Characteristics and classification of living organisms" },
      { chapterId: "0610_02", num: 2, paper2: "yes", color: "#0000C0", label: "Organisation of the organism" },
      { chapterId: "0610_03", num: 3, paper2: "yes", color: "#0000C0", label: "Movement into and out of cells" },
      { chapterId: "0610_04", num: 4, paper2: "yes", color: "#0000C0", label: "Biological molecules" },
      { chapterId: "0610_05", num: 5, paper2: "yes", color: "#0000C0", label: "Enzymes" },
      { chapterId: "0610_06", num: 6, paper2: "yes", color: "#00C000", label: "Plant nutrition" },
      { chapterId: "0610_07", num: 7, paper2: "yes", color: "#C00000", label: "Human nutrition" },
      { chapterId: "0610_08", num: 8, paper2: "yes", color: "#00C000", label: "Transport in plants" },
      { chapterId: "0610_09", num: 9, paper2: "yes", color: "#C00000", label: "Transport in animals" },
      { chapterId: "0610_10", num: 10, paper2: "yes", color: "#C00000", label: "Diseases and immunity" },
      { chapterId: "0610_11", num: 11, paper2: "yes", color: "#C00000", label: "Gas exchange in humans" },
      { chapterId: "0610_12", num: 12, paper2: "yes", color: "#C00000", label: "Respiration" },
      { chapterId: "0610_13", num: 13, paper2: "yes", color: "#C00000", label: "Excretion in humans" },
      { chapterId: "0610_14", num: 14, paper2: "yes", color: "#C00000", label: "Coordination and response" },
      { chapterId: "0610_15", num: 15, paper2: "yes", color: "#800080", label: "Drugs" },
      { chapterId: "0610_16", num: 16, paper2: "yes", color: "#C00000", label: "Reproduction" },
      { chapterId: "0610_17", num: 17, paper2: "yes", color: "#0000C0", label: "Inheritance" },
      { chapterId: "0610_18", num: 18, paper2: "yes", color: "#800080", label: "Variation and selection" },
      { chapterId: "0610_19", num: 19, paper2: "yes", color: "#800080", label: "Organisms and their environment" },
      { chapterId: "0610_20", num: 20, paper2: "yes", color: "#800080", label: "Human influences on ecosystems" },
      { chapterId: "0610_21", num: 21, paper2: "yes", color: "#800080", label: "Biotechnology and genetic modification" }
    ]
  }
]
